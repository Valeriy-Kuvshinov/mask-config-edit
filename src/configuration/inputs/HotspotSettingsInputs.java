...
public class HotspotSettingsInputs extends CustomPanel {
        ...
        private void addInputRow(CustomPanel panel, GridBagConstraints gbc, int row, int col, String key, Object value,
        ...
        private void addSelectRow(CustomPanel panel, GridBagConstraints gbc, int row, int col, String key, Object value,
